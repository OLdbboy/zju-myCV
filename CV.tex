...
\makebox[0.33\textwidth][l]{\textbf{浙江大学}}%
\makebox[0.33\textwidth][c]{2024.9 -- 至今}
\makebox[0.33\textwidth][r]{生物医学工程 | 硕士}\\[0.2em]%
\begin{itemize}[nosep]
    \item 研究方向：高速超声开放平台、超声成像算法
\end{itemize}
\makebox[0.33\textwidth][l]{荣誉：优秀研究生}
\makebox[0.33\textwidth][l]{\textbf{华中科技大学}}%
\makebox[0.33\textwidth][c]{2020.9 -- 2024.6}
\makebox[0.33\textwidth][r]{测控技术与仪器 | 本科}\\[0.2em]%
\begin{itemize}[nosep]
    \item 主修课程：电路理论、模拟电子技术、数字电路与逻辑设计、传感技术与信号电路、机电控制与检测
\end{itemize}
\makebox[0.33\textwidth][l]{荣誉：优秀毕业生、三好学生}
\makebox[0.33\textwidth][r]{GPA:3.98/4}
