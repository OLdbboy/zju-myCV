...
自主研制 128 通道\textbf{高速超声采集卡}及\textbf{可编程相控阵超声发射卡}，通过背板实现硬件互联，结合上位机软件算法完成 256 通道高速超声科研平台搭建，该平台已实现\textbf{产品化落地}。本人主要负责\textbf{FPGA}部分
% 在 itemize 的选项中，使用 topsep=\intraProjectListTopSep 来控制上边距
\begin{itemize}[nosep, topsep=\intraProjectListTopSep]
    \item \textbf{高速数据采集}：基于\textbf{高速 LVDS 接口}完成TI AFE5818超声模拟前端高达\textbf{960 Mbps}高速数据流的解串处理
